...
const resources: Service[] = [
  ...
  {
    href: "/villes",
    title: `Villes desservies en ${departementConfig.departementName}`,
  },
];
...
export default function RelatedServices({ currentService }: RelatedServicesProps) {
  ...
  const filteredResources = resources.filter((r) => !r.href.includes(currentService));
